...
`,(class t extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(p.content.cloneNode(!0))}connectedCallback(){this.setAttribute("slot","panel"),this.setAttribute("role","tabpanel"),this.setAttribute("hidden",""),this.id||(this.id=n("panel",(++u).toString()))}static defineCustomElement(e="a-tab-panel"){"u">typeof window&&!window.customElements.get(e)&&window.customElements.define(e,t)}}).defineCustomElement();var b={TOP:"top",BOTTOM:"bottom",START:"start",END:"end"},g={LTR:"ltr",RTL:"rtl"},f=Object.entries(b).map(([,t])=>t),v={AUTO:"auto",MANUAL:"manual"},y={DOWN:"ArrowDown",LEFT:"ArrowLeft",RIGHT:"ArrowRight",UP:"ArrowUp",HOME:"Home",END:"End",ENTER:"Enter",SPACE:" "},w=`
  :host {
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var D=document.createElement("template"),B=`
  :host {
    --me-width: 32rem;
...
`,ts=document.createElement("style");function ta(t){t&&(t.querySelector("bs-result")?.remove(),t.querySelectorAll(".model-info").forEach(t=>t.remove()))}async function tn(t,e){if(!t||!e)return;ta(t);let o=function(t){let e="",o="";o=t.includes("PWS130721000001")?te[t.substring(t.length-9)]||"Neznámy model":t.includes("#4M")?te[t.replace(/[^A-Za-z0-9]/g,"")]||"Neznámy model":te[t.substring(0,11)]||"Neznámy model",e+=`Model: ${o}
`;let i=t.substring(11,13),r=`20${i}`,s=t.substring(13,16),a=t.substring(16,21),n=t.substring(21,22),l=t.substring(22,24),d=t.substring(24,27),c=t.substring(27,30),h=t.substring(30,36),u=parseInt(s,10);return u<1||u>365?e+=`De\u{148} v roku: Nezn\xe1my de\u{148} (${s})
`:e+=`De\u{148} v roku v\xfdroby: ${s}
`,"2024"===r?e+=`Rok produkcie: 2024
`:e+=`Rok produkcie: Nezn\xe1my rok (${r})
`,e+=`Poradov\xe9 \u{10D}\xedslo kusu: ${a}
`,"0"===n?e+=`L\xednia: ${n}
`:e+=`L\xednia: Nezn\xe1ma l\xednia (${n})
`,"20"===l?e+=`K\xf3d v\xfdrobcu: ${l}
`:e+=`K\xf3d v\xfdrobcu: Nezn\xe1my k\xf3d v\xfdrobcu (${l})
`,d===(to[o]||"Neznámy ZGS Stand")?e+=`ZGS stand: ${d}
`:e+=`ZGS stand: Nezn\xe1my ZGS Stand (${d})
`,c===(ti[o]||"Neznámy Q-Stand")?e+=`Q-stand: ${c}
`:e+=`Q-stand: Nezn\xe1my Q-Stand (${c})
`,e+=`Vo\u{13E}n\xe9 poz\xedcie: ${h}
`}(e),i=document.createElement("bs-result");i.setAttribute("value",e),i.setAttribute("model",o),i.setAttribute("role","alert"),i.setAttribute("aria-live","assertive"),i.setAttribute("aria-atomic","true"),t.appendChild(i);let r=document.createElement("div");r.classList.add("model-info-container"),o.split("\n").filter(t=>""!==t.trim()).forEach(t=>{let e=document.createElement("div");e.classList.add("model-info"),(t.includes("Neznámy model")||t.includes("Neznámy rok")||t.includes("Neznámy deň")||t.includes("Neznáma línia")||t.includes("Neznámy kód výrobcu")||t.includes("Neznámy ZGS Stand")||t.includes("Neznámy Q-Stand"))&&e.classList.add("unknown"),e.textContent=t,r.appendChild(e)}),t.appendChild(r)}ts.type="text/css",ts.innerText=tr,document.head.appendChild(ts);const tl=(()=>{let t=new(window.AudioContext||window.webkitAudioContext||window.audioContext);if(t)return e=>{let{duration:o,frequency:i,volume:r,type:s,onEnded:a}=e,n=t.createOscillator(),l=t.createGain();n.connect(l),l.connect(t.destination),r&&(l.gain.value=r),i&&(n.frequency.value=i),s&&(n.type=s),"function"==typeof a&&(n.onended=a),n.start(t.currentTime),n.stop(t.currentTime+(o||500)/1e3)}})();async function td(t=0){if("function"==typeof window.navigator.vibrate)try{window.navigator.vibrate(t)}catch{}}async function tc(t={}){let{success:e=!0}=t,[,o]=await Y();o&&(o.beep&&tl(e?{duration:200,frequency:860,volume:.03,type:"square"}:{duration:300,frequency:200,volume:.05,type:"sawtooth"}),o.vibrate&&td(e?100:200))}function th(t,e){if(!t||!e)return;let o=t.getBoundingClientRect();e.style.cssText=`width: ${o.width}px; height: ${o.height}px`}const tu=["aztec","code_128","code_39","code_93","codabar","data_matrix","ean_13","ean_8","itf","pdf417","qr_code","upc_a","upc_e"];class tm{static async polyfill(){if(!("BarcodeDetector"in window))try{await s("cw9o9")}catch(t){throw Error("BarcodeDetector API is not supported by your browser.",{cause:t})}}static async getSupportedFormats(){let t=await window.BarcodeDetector.getSupportedFormats()||[];return tu.filter(e=>t.includes(e))}static async create(t){let e=Array.isArray(t)&&t.length>0?t:await tm.getSupportedFormats();return new tm(e)}static async setup(){try{return await tm.polyfill(),{barcodeReaderError:null}}catch(t){return{barcodeReaderError:t}}}constructor(t){this.barcodeReader=new window.BarcodeDetector({formats:t})}async detect(t){if(!this.barcodeReader)throw Error("BarcodeReader is not initialized.");let e=await this.barcodeReader.detect(t);if(Array.isArray(e)&&e.length>0){let t=e[0];return t.rawValue,t.format,t}throw Error("Could not detect barcode from provided source.")}}function tp(t={}){let{el:e,isTorchOn:o}={el:document.getElementById("torchButton"),isTorchOn:!1,...t},i=e.querySelectorAll("svg path");2===i.length&&(i[0].style.display=o?"none":"block",i[1].style.display=o?"block":"none",e.setAttribute("aria-label",`Turn ${o?"off":"on"} flash`))}const tb="video-capture",tg=`
...
`,tf=document.createElement("template");tf.innerHTML=`
  ...
  <slot></slot>
`;class tv extends HTMLElement{#C={};#z=null;#S=null;constructor(){super(),this.#C=this.getSupportedConstraints(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tf.content.cloneNode(!0))}static get observedAttributes(){return["no-image","pan","tilt","zoom","torch"]}attributeChangedCallback(t,e,o){if(!this.isConnected)return;let i=this.getTrackCapabilities();if("zoom"===t&&e!==o&&"zoom"in this.#C){let t=!!("zoom"in i&&i.zoom?.min&&i.zoom?.max)&&this.zoom>=i.zoom.min&&this.zoom<=i.zoom.max;"number"==typeof this.zoom&&t&&this.#L("zoom",this.zoom)}"torch"===t&&e!==o&&"torch"in this.#C&&this.#L("torch",this.torch)}async connectedCallback(){if(this.#T("autoPlay"),this.#T("facingMode"),this.#T("zoom"),this.#T("torch"),this.#S=this.shadowRoot?.querySelector("video")||null,this.#S?.addEventListener("loadedmetadata",this.#_),!tv.isSupported())return this.dispatchEvent(new CustomEvent(`${tb}:error`,{bubbles:!0,composed:!0,detail:{error:{name:"NotSupportedError",message:"Not supported"}}}));this.autoPlay&&this.startVideoStream()}disconnectedCallback(){this.stopVideoStream(),this.#S?.removeEventListener("loadedmetadata",this.#_)}get autoPlay(){return this.hasAttribute("auto-play")}set autoPlay(t){this.toggleAttribute("auto-play",!!t)}get facingMode(){let t=this.getAttribute("facing-mode");return"user"!==t?"environment":t}set facingMode(t){this.setAttribute("facing-mode",t)}get zoom(){return Number(this.getAttribute("zoom"))||1}set zoom(t){this.setAttribute("zoom",null!=t?t.toString():t)}get torch(){return this.hasAttribute("torch")}set torch(t){this.toggleAttribute("torch",!!t)}get loading(){return this.hasAttribute("loading")}#_=t=>{let e=t.target;e.play().then(()=>{this.dispatchEvent(new CustomEvent(`${tb}:video-play`,{bubbles:!0,composed:!0,detail:{video:e}}))}).catch(t=>{this.dispatchEvent(new CustomEvent(`${tb}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}).finally(()=>{this.removeAttribute("loading")})};#L(t,e){var o,i,r;if(!this.#z)return;let[s]=this.#z.getVideoTracks(),a=this.getTrackCapabilities(),n=this.getTrackSettings(),l="pan"===t||"tilt"===t||"zoom"===t?(o=Number(e),i=a[t]?.min||1,r=a[t]?.max||1,Number.isNaN(i)&&(i=0),Number.isNaN(r)&&(r=0),Math.min(Math.max(o,Math.min(i,r)),Math.max(i,r))):e;t in n&&s.applyConstraints({advanced:[{[t]:l}]}).catch(()=>{})}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}async startVideoStream(t){if(!tv.isSupported()||this.#z)return;this.setAttribute("loading","");let e={video:{facingMode:{ideal:this.facingMode},pan:!0,tilt:!0,zoom:!0,torch:this.torch},audio:!1};if("string"==typeof t&&t.trim().length>0&&(e.video.deviceId={exact:t}),"string"==typeof this.cameraResolution&&this.cameraResolution.trim().length>0){let[t=0,o=0]=this.cameraResolution.split("x").map(t=>Number(t));t>0&&o>0&&(e.video.width=t,e.video.height=o)}try{this.#z=await navigator.mediaDevices.getUserMedia(e),this.#S&&(this.#S.srcObject=this.#z),this.#L("pan",this.pan),this.#L("tilt",this.tilt),this.#L("zoom",this.zoom)}catch(t){this.dispatchEvent(new CustomEvent(`${tb}:error`,{bubbles:!0,composed:!0,detail:{error:t}}))}finally{this.removeAttribute("loading")}}restartVideoStream(t){this.#z&&this.#S&&this.stopVideoStream(),this.startVideoStream(t)}stopVideoStream(){if(!this.#S||!this.#z)return;let[t]=this.#z.getVideoTracks();t?.stop(),this.#S.srcObject=null,this.#z=null}getSupportedConstraints(){return tv.isSupported()&&navigator.mediaDevices.getSupportedConstraints()||{}}getTrackCapabilities(){if(!this.#z)return{};let[t]=this.#z.getVideoTracks();return t&&"function"==typeof t.getCapabilities&&t.getCapabilities()||{}}getTrackSettings(){if(!this.#z)return{};let[t]=this.#z.getVideoTracks();return t&&"function"==typeof t.getSettings&&t.getSettings()||{}}static async getVideoInputDevices(){return navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices?(await navigator.mediaDevices.enumerateDevices()||[]).filter(t=>"videoinput"===t.kind&&!!t.deviceId):[]}static isSupported(){return!!navigator.mediaDevices?.getUserMedia}static defineCustomElement(t=tb){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tv)}}/*!
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var ty="clipboard-copy",tw="success",tE="error",tA=document.createElement("template"),tx=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function tz(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}tC.defineCustomElement();const tS=`
  :host {
    box-sizing: border-box;
  }
...
`;class tT extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tL.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#M(this.value)}connectedCallback(){if(this.#T("value"),!tz()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #M(t){let e;let o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__actions"),r=o?.querySelector(".result__item");r&&r.remove();try{let[,o]=await Y();new URL(t),(e=document.createElement("a")).href=t,window.requestAnimationFrame(()=>e.focus()),o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage&&e.click()}catch{e=document.createElement("span")}e.className="result__item",e.classList.toggle("result__item--no-barcode",t===F),e.textContent=t,o?.insertBefore(e,i);let s=t!==F,a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");a&&s?(a.setAttribute("value",t),a.hidden=!1):(a.hidden=!0,a.removeAttribute("value")),n&&tz()&&s?(n.setAttribute("share-text",t),n.hidden=!1):(n.hidden=!0,n.removeAttribute("share-text"))}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tT)}}tT.defineCustomElement();class t_ extends HTMLElement{#R=null;#N=null;#q=[];#$;constructor(){super()}get supportedFormats(){return this.#q}set supportedFormats(t){this.#q=t,this.#O()}async connectedCallback(){this.#T("supportedFormats"),this.#R=this.querySelector("#formatsList"),this.#N=this.querySelector("form");let[,t]=await Y();this.#$=t??{},this.#N?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#$[t.value]})}#O(){if(!this.#R)return;let t=this.#$?.formats;this.#R.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#R.appendChild(o)})}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,t_)}}t_.defineCustomElement();const tM=`
  :host {
...
`;class tN extends HTMLElement{#H=null;#I=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tR.content.cloneNode(!0))}async connectedCallback(){this.#H=this.shadowRoot?.getElementById("historyList"),this.#I=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#D((await K())[1]||[]),this.#H?.addEventListener("click",this.#B),this.#I?.addEventListener("click",this.#F)}disconnectedCallback(){this.#H?.removeEventListener("click",this.#B),this.#I?.removeEventListener("click",this.#F)}async add(t){let[,e]=await Y();if(!t||!e?.addToHistory)return;let[o,i=[]]=await K();if(!o&&Array.isArray(i)&&!i.find(e=>e===t)){let e=[...i,t],[o]=await J(e);o||this.#H.appendChild(this.#P(t))}}async remove(t){if(!t)return;let[e,o=[]]=await K();if(!e&&Array.isArray(o)){let e=o.filter(e=>e!==t),[i]=await J(e);if(!i){let e=this.#H.querySelector(`li[data-value="${t}"]`);e&&e.remove()}}}async empty(){let[t]=await J([]);t||this.#H.replaceChildren()}#D(t){if(!this.#H)return;this.#H.replaceChildren();let e=document.createDocumentFragment();t.forEach(t=>{e.appendChild(this.#P(t))}),this.#H.appendChild(e)}#P(t){let e;let o=window.crypto&&"function"==typeof window.crypto.randomUUID?window.crypto.randomUUID():Array.from({length:5},()=>Math.random().toString(36).substring(2,8)).join("-"),i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t,e.setAttribute("id",`historyItem-${o}`);let r=document.createElement("div");r.className="actions";let s=document.createElement("custom-clipboard-copy");s.setAttribute("id",`copyHistoryItem-${o}`),s.setAttribute("aria-label","Copy to clipboard"),s.setAttribute("aria-labelledby",`copyHistoryItem-${o} historyItem-${o}`),s.setAttribute("only-icon",""),s.setAttribute("value",t),r.appendChild(s);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("id",`removeHistoryItem-${o}`),a.setAttribute("aria-label","Remove from history"),a.setAttribute("aria-labelledby",`removeHistoryItem-${o} historyItem-${o}`),a.innerHTML=`
    ...
    `,r.appendChild(a),i.appendChild(e),i.appendChild(r),i}#B=t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#F=()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tN)}}tN.defineCustomElement(),async function(){let t;let e=document.querySelector("a-tab-group"),o=document.querySelector("video-capture"),i=document.querySelector("bs-settings"),r=document.querySelector("bs-history"),s=document.getElementById("cameraPanel"),a=document.getElementById("filePanel"),n=document.getElementById("scanInstructions"),l=document.getElementById("scanBtn"),d=document.getElementById("dropzone"),c=document.querySelector("resize-observer"),h=document.getElementById("scanFrame"),u=document.getElementById("torchButton"),m=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),g=document.getElementById("settingsBtn"),f=document.getElementById("settingsDialog"),v=document.getElementById("settingsForm"),y=document.getElementById("cameraSelect"),w=!0;"function"==typeof HTMLDialogElement&&(m?.removeAttribute("hidden"),b?.removeAttribute("hidden"),f?.removeAttribute("hidden"));let{barcodeReaderError:E}=await tm.setup();if(E){let t=document.getElementById("barcodeReaderError");w=!1,m?.setAttribute("hidden",""),e?.setAttribute("hidden",""),t?.removeAttribute("hidden"),t.textContent=E?.message;return}let A=await tm.getSupportedFormats(),[,x]=await Y(),k=x?.formats||A,C=await tm.create(k);o.addEventListener("video-capture:video-play",_,{once:!0}),o.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tv.defineCustomElement();let z=o?.shadowRoot,S=z?.querySelector("video"),L=z?.querySelector('[part="actions-container"]');async function T(){n?.removeAttribute("hidden");try{let e=await C.detect(S),o=e?.rawValue??"";if(!o)throw Error(F);window.cancelAnimationFrame(t),ta(s),tn(s,`${o}`),r?.add(o),n?.setAttribute("hidden",""),l?.removeAttribute("hidden"),h?.setAttribute("hidden",""),L?.setAttribute("hidden",""),tc();return}catch{}w&&(t=window.requestAnimationFrame(()=>T()))}async function _(t){h?.removeAttribute("hidden"),th(t.detail.video,h),T();let e=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(u?.removeAttribute("hidden"),o.hasAttribute("torch")&&tp({el:u,isTorchOn:!0})),e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=e?.zoom||1;t?.removeAttribute("hidden"),r.textContent=n,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n,o.zoom=n})}let s=await tv.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,y.appendChild(o)}),s.length>1&&y?.removeAttribute("hidden")}async function M(t){t.preventDefault();let e={},o=new FormData(v),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,X(e),"formats-settings"===t.target.name&&(C=await tm.create(r))}d.accept=P.join(","),i.supportedFormats=A,l.addEventListener("click",function(){l?.setAttribute("hidden",""),h?.removeAttribute("hidden"),L?.removeAttribute("hidden"),ta(s),T()}),e.addEventListener("a-tab-show",tt(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(w=!0,!o)return;let t=null!=s.querySelector("bs-result");if(o.loading||t||(h?.removeAttribute("hidden"),L?.removeAttribute("hidden"),T()),"function"==typeof o.startVideoStream){let t=y?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),h?.setAttribute("hidden",""),L?.setAttribute("hidden",""))},250)),d.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let i=o.target.result;e.onload=async()=>{try{let t=await C.detect(e),o=t?.rawValue??"";if(!o)throw Error(F);tn(a,o),r?.add(o),tc()}catch(t){tn(a,F),tc({success:!1})}},e.src=i,e.alt="Image preview",d.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview",s.setAttribute("aria-hidden","true");let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,n.appendChild(e),s.appendChild(n),s.appendChild(l),d.prepend(s)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),c.addEventListener("resize-observer:resize",function(){th(o.shadowRoot.querySelector("video"),h)}),g.addEventListener("click",function(){f.open=!0}),v.addEventListener("change",tt(M,500)),p.addEventListener("click",function(){b.open=!0}),u.addEventListener("click",function(t){o.torch=!o.torch,tp({el:t.currentTarget,isTorchOn:o.hasAttribute("torch")})}),y.addEventListener("change",function(t){if("function"!=typeof o.restartVideoStream)return;let e=t.target.value||void 0;o.restartVideoStream(e)}),document.addEventListener("visibilitychange",function(){if("cameraTab"===e.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream();else{w=!0;let t=document.querySelector("video-capture");if(!t)return;if(t.loading||s.querySelector("bs-result")||T(),"function"==typeof t.startVideoStream){let e=y?.value||void 0;t.startVideoStream(e)}}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=e.querySelector("#cameraTab").hasAttribute("selected"),o=!l.hidden,i=f.hasAttribute("open"),r=b.hasAttribute("open");o&&t&&!(i||r)&&l.click()}()})}();
//# sourceMappingURL=index.0e2f58d6.js.map
