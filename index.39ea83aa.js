 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var tb="clipboard-copy",tg="success",tf="error",tv=document.createElement("template"),ty=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function tA(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}tE.defineCustomElement();let tx=`
  :host {
    box-sizing: border-box;
  }
...
`;class tC extends HTMLElement{constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tk.content.cloneNode(!0))}get value(){return this.getAttribute("value")}set value(t){this.setAttribute("value",t)}static get observedAttributes(){return["value"]}attributeChangedCallback(t,e,o){"value"===t&&e!==o&&this.#M(this.value)}connectedCallback(){if(this.#T("value"),!tA()){let t=this.shadowRoot.querySelector("web-share");t&&(t.hidden=!0)}}async #M(t){let e;let o=this.shadowRoot.querySelector(".result"),i=o?.querySelector(".result__actions"),r=o?.querySelector(".result__item");r&&r.remove();try{let[,o]=await J();new URL(t),(e=document.createElement("a")).href=t,window.requestAnimationFrame(()=>e.focus()),o?.openWebPageSameTab||(e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")),o?.openWebPage&&e.click()}catch{e=document.createElement("span")}e.className="result__item",e.classList.toggle("result__item--no-barcode",t===F),e.textContent=t,o?.insertBefore(e,i);let s=t!==F,a=o?.querySelector("custom-clipboard-copy"),n=o?.querySelector("web-share");a&&s?(a.setAttribute("value",t),a.hidden=!1):(a.hidden=!0,a.removeAttribute("value")),n&&tA()&&s?(n.setAttribute("share-text",t),n.hidden=!1):(n.hidden=!0,n.removeAttribute("share-text"))}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-result"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tC)}}tC.defineCustomElement();class tL extends HTMLElement{#R=null;#q=null;#N=[];#O;constructor(){super()}get supportedFormats(){return this.#N}set supportedFormats(t){this.#N=t,this.#H()}async connectedCallback(){this.#T("supportedFormats"),this.#R=this.querySelector("#formatsList"),this.#q=this.querySelector("form");let[,t]=await J();this.#O=t??{},this.#q?.querySelectorAll('[name="general-settings"]').forEach(t=>{t.checked=this.#O[t.value]})}#H(){if(!this.#R)return;let t=this.#O?.formats;this.#R.replaceChildren(),this.supportedFormats.forEach(e=>{let o=document.createElement("li"),i=document.createElement("label"),r=document.createElement("input");r.type="checkbox",r.name="formats-settings",r.value=e,r.checked=null==t||t.includes(e),i.appendChild(r),i.appendChild(document.createTextNode(e)),o.appendChild(i),this.#R.appendChild(o)})}#T(t){if(Object.prototype.hasOwnProperty.call(this,t)){let e=this[t];delete this[t],this[t]=e}}static defineCustomElement(t="bs-settings"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tL)}}tL.defineCustomElement();let tS=`
  :host {
...
`;class tT extends HTMLElement{#I=null;#$=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(tz.content.cloneNode(!0))}async connectedCallback(){this.#I=this.shadowRoot?.getElementById("historyList"),this.#$=this.shadowRoot?.getElementById("emptyHistoryBtn"),this.#B((await X())[1]||[]),this.#I?.addEventListener("click",this.#D),this.#$?.addEventListener("click",this.#F)}disconnectedCallback(){this.#I?.removeEventListener("click",this.#D),this.#$?.removeEventListener("click",this.#F)}async add(t){let[,e]=await J();if(!t||!e?.addToHistory)return;let[o,i=[]]=await X();if(!o&&Array.isArray(i)&&!i.find(e=>e===t)){let e=[...i,t],[o]=await Q(e);o||this.#I.appendChild(this.#P(t))}}async remove(t){if(!t)return;let[e,o=[]]=await X();if(!e&&Array.isArray(o)){let e=o.filter(e=>e!==t),[i]=await Q(e);if(!i){let e=this.#I.querySelector(`li[data-value="${t}"]`);e&&e.remove()}}}async empty(){let[t]=await Q([]);t||this.#I.replaceChildren()}#B(t){if(!this.#I)return;this.#I.replaceChildren();let e=document.createDocumentFragment();t.forEach(t=>{e.appendChild(this.#P(t))}),this.#I.appendChild(e)}#P(t){let e;let o=window.crypto&&"function"==typeof window.crypto.randomUUID?window.crypto.randomUUID():Array.from({length:5},()=>Math.random().toString(36).substring(2,8)).join("-"),i=document.createElement("li");i.setAttribute("data-value",t);try{new URL(t),(e=document.createElement("a")).href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noreferrer noopener")}catch{e=document.createElement("span")}e.textContent=t,e.setAttribute("id",`historyItem-${o}`);let r=document.createElement("div");r.className="actions";let s=document.createElement("custom-clipboard-copy");s.setAttribute("id",`copyHistoryItem-${o}`),s.setAttribute("aria-label","Copy to clipboard"),s.setAttribute("aria-labelledby",`copyHistoryItem-${o} historyItem-${o}`),s.setAttribute("only-icon",""),s.setAttribute("value",t),r.appendChild(s);let a=document.createElement("button");return a.type="button",a.className="delete-action",a.setAttribute("data-action","delete"),a.setAttribute("id",`removeHistoryItem-${o}`),a.setAttribute("aria-label","Remove from history"),a.setAttribute("aria-labelledby",`removeHistoryItem-${o} historyItem-${o}`),a.innerHTML=`
    ...
    `,r.appendChild(a),i.appendChild(e),i.appendChild(r),i}#D=t=>{let e=t.target;if(e.closest('[data-action="delete"]')){let t=e.closest("li").dataset.value;window.confirm(`Delete history item ${t}?`)&&this.remove(t)}};#F=()=>{window.confirm("Empty history? This action cannot be undone.")&&this.empty()};static defineCustomElement(t="bs-history"){"undefined"==typeof window||window.customElements.get(t)||window.customElements.define(t,tT)}}tT.defineCustomElement(),async function(){let t;let e=document.querySelector("a-tab-group"),o=document.querySelector("video-capture"),i=document.querySelector("bs-settings"),r=document.querySelector("bs-history"),s=document.getElementById("cameraPanel"),a=document.getElementById("filePanel"),n=document.getElementById("scanInstructions"),l=document.getElementById("scanBtn"),d=document.getElementById("dropzone"),c=document.querySelector("resize-observer"),h=document.getElementById("scanFrame"),u=document.getElementById("torchButton"),m=document.getElementById("globalActions"),p=document.getElementById("historyBtn"),b=document.getElementById("historyDialog"),g=document.getElementById("settingsBtn"),f=document.getElementById("settingsDialog"),v=document.getElementById("settingsForm"),y=document.getElementById("cameraSelect"),w=!0;"function"==typeof HTMLDialogElement&&(m?.removeAttribute("hidden"),b?.removeAttribute("hidden"),f?.removeAttribute("hidden"));let{barcodeReaderError:E}=await td.setup();if(E){let t=document.getElementById("barcodeReaderError");w=!1,m?.setAttribute("hidden",""),e?.setAttribute("hidden",""),t?.removeAttribute("hidden"),t.textContent=E?.message;return}let A=await td.getSupportedFormats(),[,x]=await J(),k=x?.formats||A,C=await td.create(k);o.addEventListener("video-capture:video-play",_,{once:!0}),o.addEventListener("video-capture:error",function(t){let e=t.detail.error;if("NotFoundError"===e.name)return;let o="NotAllowedError"===e.name?"Permission to use webcam was denied or video Autoplay is disabled. Reload the page to give appropriate permissions to webcam.":e.message;s.innerHTML=`<div class="alert alert-danger" role="alert" style="margin: 0;">${o}</div>`},{once:!0}),tp.defineCustomElement();let L=o?.shadowRoot,S=L?.querySelector("video"),z=L?.querySelector('[part="actions-container"]');async function T(){n?.removeAttribute("hidden");try{let e=await C.detect(S),o=e?.rawValue??"";if(!o)throw Error(F);let i=to(o);window.cancelAnimationFrame(t),ti(s,`${o}
${i}`),r?.add(o),n?.setAttribute("hidden",""),l?.removeAttribute("hidden"),h?.setAttribute("hidden",""),z?.setAttribute("hidden",""),ta();return}catch{}w&&(t=window.requestAnimationFrame(()=>T()))}async function _(t){h?.removeAttribute("hidden"),tn(t.detail.video,h),T();let e=t.target.getTrackSettings(),i=t.target.getTrackCapabilities(),r=document.getElementById("zoomLevel");if(i?.torch&&(u?.removeAttribute("hidden"),o.hasAttribute("torch")&&tc({el:u,isTorchOn:!0})),e?.zoom&&i?.zoom){let t=document.getElementById("zoomControls"),s=i?.zoom?.min||0,a=i?.zoom?.max||10,n=e?.zoom||1;t?.removeAttribute("hidden"),r.textContent=n,t.addEventListener("click",t=>{let e=t.target.closest('[data-action="zoom-in"]'),i=t.target.closest('[data-action="zoom-out"]');e&&n<a&&(n+=.5),i&&n>s&&(n-=.5),r.textContent=n,o.zoom=n})}let s=await tp.getVideoInputDevices();s.forEach((t,e)=>{let o=document.createElement("option");o.value=t.deviceId,o.textContent=t.label||`Camera ${e+1}`,y.appendChild(o)}),s.length>1&&y?.removeAttribute("hidden")}async function M(t){t.preventDefault();let e={},o=new FormData(v),i=o.getAll("general-settings"),r=o.getAll("formats-settings");i.forEach(t=>e[t]=!0),e.formats=r,K(e),"formats-settings"===t.target.name&&(C=await td.create(r))}d.accept=P.join(","),i.supportedFormats=A,l.addEventListener("click",function(){l?.setAttribute("hidden",""),h?.removeAttribute("hidden"),z?.removeAttribute("hidden"),s&&s.querySelector("bs-result")?.remove(),T()}),e.addEventListener("a-tab-show",tt(function(t){let e=t.detail.tabId,o=document.querySelector("video-capture");if("cameraTab"===e){if(w=!0,!o)return;let t=null!=s.querySelector("bs-result");if(o.loading||t||(h?.removeAttribute("hidden"),z?.removeAttribute("hidden"),T()),"function"==typeof o.startVideoStream){let t=y?.value||void 0;o.startVideoStream(t)}}else"fileTab"===e&&(w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream(),h?.setAttribute("hidden",""),z?.setAttribute("hidden",""))},250)),d.addEventListener("files-dropzone-drop",function(t){!function(t){if(!t)return;let e=new Image,o=new FileReader;o.onload=o=>{let i=o.target.result;e.onload=async()=>{try{let t=await C.detect(e),o=t?.rawValue??"";if(!o)throw Error(F);ti(a,o),r?.add(o),ta()}catch(t){ti(a,F),ta({success:!1})}},e.src=i,e.alt="Image preview",d.replaceChildren();let s=document.createElement("div");s.className="dropzone-preview",s.setAttribute("aria-hidden","true");let n=document.createElement("div");n.className="dropzone-preview__image-wrapper";let l=document.createElement("div");l.className="dropzone-preview__file-name",l.textContent=t.name,n.appendChild(e),s.appendChild(n),s.appendChild(l),d.prepend(s)},o.readAsDataURL(t)}(t.detail.acceptedFiles[0])}),c.addEventListener("resize-observer:resize",function(){tn(o.shadowRoot.querySelector("video"),h)}),g.addEventListener("click",function(){f.open=!0}),v.addEventListener("change",tt(M,500)),p.addEventListener("click",function(){b.open=!0}),u.addEventListener("click",function(t){o.torch=!o.torch,tc({el:t.currentTarget,isTorchOn:o.hasAttribute("torch")})}),y.addEventListener("change",function(t){if("function"!=typeof o.restartVideoStream)return;let e=t.target.value||void 0;o.restartVideoStream(e)}),document.addEventListener("visibilitychange",function(){if("cameraTab"===e.querySelector("[selected]").getAttribute("id")){if("hidden"===document.visibilityState)w=!1,null!=o&&"function"==typeof o.stopVideoStream&&o.stopVideoStream();else{w=!0;let t=document.querySelector("video-capture");if(!t)return;if(t.loading||s.querySelector("bs-result")||T(),"function"==typeof t.startVideoStream){let e=y?.value||void 0;t.startVideoStream(e)}}}}),document.addEventListener("keydown",function(t){"Escape"===t.key&&function(){let t=e.querySelector("#cameraTab").hasAttribute("selected"),o=!l.hidden,i=f.hasAttribute("open"),r=b.hasAttribute("open");o&&t&&!(i||r)&&l.click()}()})}()}();
//# sourceMappingURL=index.39ea83aa.js.map
