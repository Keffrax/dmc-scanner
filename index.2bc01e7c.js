 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var tb="clipboard-copy",tg="success",tv="error",tf=document.createElement("template"),ty=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */function tA(t){return null!==t&&"object"==typeof t?"share"in navigator&&"canShare"in navigator&&navigator.canShare(t):"share"in navigator}tE.defineCustomElement();const tx=`
  :host {
    box-sizing: border-box;
  }
