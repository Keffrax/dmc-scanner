 ...
 * @author George Raptis <georapbox@gmail.com>
 * @license MIT
 */var ey="clipboard-copy",ew="success",eE="error",eA=document.createElement("template"),ex=`
  :host([hidden]),
  [hidden],
  ::slotted([hidden]) {
    display: none !important;
